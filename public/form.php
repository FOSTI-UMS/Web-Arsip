    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">
                        <center>Masukkan Dokumen</center>
                    </h2>
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nomer_dokumen" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="p-t-15">
                            <center><button class="btn btn--radius-2 btn--blue" type="submit" name="submit">Masukkan</button>
                                <a class="btn btn--radius btn--red" href="../index">Batal</a></center</center> </div> </form> </div> </div> </div> </div> <!-- Jquery JS-->
...
if (isset($_POST['submit'])) {
    ...
    function upload()
    {
        ...
        global $divisi;
        global $nomer;
        move_uploaded_file($tmpName, '../dokumen/' . $divisi . '/' . $namaFile);
    ...
    $sql = "INSERT INTO dokumen(nama,tanggal,divisi,jenis,file,id,nomer) VALUES ('$nama','$tanggal','$divisi','$jenis','$file','','$nomer')";
